		...
		<div className="max-w-7xl mx-auto bg-white rounded-lg shadow-xl p-8">
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
				  {metrics.map((metric, index)=>{
					return (
						<div key={index}
							className={`flex justify-between items-center bg-white rounded-lg shadow-md p-6 border-l-4 ${metric.isPositive ? "border-green-500" : "border-red-500"
								}`}
						> 
							<div>
			...
			<div className="mb-8">
				...
				<ul className="space-y4">
					...
					<li className="flex items-center justify-between bg-white rounded-lg shadow-md p-4 mt-4">
						<div>
					...
					<li className="flex items-center justify-between bg-white rounded-lg shadow-md p-4 mt-4">
						<div>
							...
							<p className="text-sm text-gray-600">
								Trafic increase by 8% on 2025-02-13
							</p>
						</div>
						<div>
